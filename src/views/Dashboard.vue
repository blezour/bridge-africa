<template>
    <div class="dashboard">
        <h4>Hi Welcome   {{ userProfile.name }}</h4>
      ...
      <v-col md="4">  <GameForm @game:added="addGame" /> </v-col>
        ...
        tile
         ...
         >
                    ...
                    <v-card-title class="justify-center" >{{ game.title }}</v-card-title>
                    <v-card-text>
...
<v-btn
      ...
      @click="deleteConfirm(game.id, game.title)" 
    >
      <v-icon dark>
        mdi-delete
      </v-icon>
